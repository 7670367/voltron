...
CENTRIFUGE_INDEXES="/gpfs0/work/joshua.theisen/species_calls/centrifuge_indices/p_h_v_index"
# so I'm using this line to run centrifuge from the folder with the index
cd /gpfs0/work/joshua.theisen/species_calls/centrifuge_indices/p_h_v_index
