...
date
echo script: srun_cent_test_1l_2f_4000r.sh
echo centrifuge test: 1 lane, 2 file, 4000 reads
echo centrifuge report file name: L1-2_head.centrep
echo centrifuge classification output file name: L1-2_head.centclass
...
less /gpfs0/work/joshua.theisen/projects/species_identification/data/HIC11383_S45_L002_R1_001_190927.fastq.gz | \
	head -4000 > /gpfs0/work/joshua.theisen/projects/species_identification/test_fastq/L002_R1_head.fastq
less /gpfs0/work/joshua.theisen/projects/species_identification/data/HIC11383_S45_L002_R2_001_190927.fastq.gz | \
	head -4000 > /gpfs0/work/joshua.theisen/projects/species_identification/test_fastq/L002_R2_head.fastq
...
centrifuge \
	-x p+h+v \
	-1 /gpfs0/work/joshua.theisen/projects/species_identification/test_fastq/L001_R1_head.fastq,/gpfs0/work/joshua.theisen/projects/species_identification/test_fastq/L002_R1_head.fastq \
	-2 /gpfs0/work/joshua.theisen/projects/species_identification/test_fastq/L001_R2_head.fastq,/gpfs0/work/joshua.theisen/projects/species_identification/test_fastq/L002_R2_head.fastq \
	--report-file /gpfs0/work/joshua.theisen/projects/species_identification/L1-2_head.centrep \
	-S /gpfs0/work/joshua.theisen/projects/species_identification/L1-2_head.centclass
